import { ffmpegUrl, type Demuxer, type WorkerInitFFmpegOnlyModule, type WorkerRequestAnswered, type WorkerRequestDemuxers, type WorkerSubmitDemuxers } from "../SomeTypes.js";
