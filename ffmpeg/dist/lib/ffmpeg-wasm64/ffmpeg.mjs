...
function read_packet(opaque, buf, buf_size) {
...
function assignWasmExports(wasmExports) {
  ...
  _set_stream_support = Module["_set_stream_support"] = createExportWrapper("set_stream_support", wasmExports["set_stream_support"], 1);
