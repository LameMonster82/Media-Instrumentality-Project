...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("ffmpeg-wasm32.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("ffmpeg-wasm32.wasm", import.meta.url).href;
}
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    worker = new Worker(new URL("ffmpeg-wasm32.mjs", import.meta.url), {
      "type": "module",
      // This is the way that we signal to the Web Worker that it is hosting
      // a pthread.
      "name": "em-pthread-" + PThread.nextWorkerID
...
function assignWasmExports(wasmExports) {
  ...
  _ff_h264_cabac_tables = Module["_ff_h264_cabac_tables"] = wasmExports["ff_h264_cabac_tables"].value;
}
