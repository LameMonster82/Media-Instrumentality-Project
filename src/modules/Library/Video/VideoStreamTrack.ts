import { VideoTrackGenerator, WorkerVideoFrame, WorkerVideoFrameBufferInit, StreamTrackNeeds, WorkerVideoFrameImageBitmap } from "../SomeTypes.js";
...
export class VideoStreamTrack implements StreamTrackNeeds<WorkerVideoFrame | WorkerVideoFrameBufferInit | WorkerVideoFrameImageBitmap> {
    ...
    CreateSafariTrack() {
        this.worker = new Worker(new URL('./src/modules/Library/Video/VideoStreamTrack.js', import.meta.url), { type: 'module' });
