...
import type { WebVideoDecoderMessage, WebAudioDecoderMessage, WebDecoderGeneralMessage, WorkerRequestAnswered, WorkerVideoFrame, WorkerVideoFrameImageBitmap, WorkerAudioData, WebDecoderQueueMessage } from "@/modules/SomeTypes";
