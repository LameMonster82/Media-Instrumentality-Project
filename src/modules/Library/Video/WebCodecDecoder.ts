...
import { WebAudioDecoderMessage, WebDecoderGeneralMessage, WebDecoderQueueMessage, WebVideoDecoderMessage, WorkerAudioData, WorkerRequestAnswered, WorkerVideoFrame, WorkerVideoFrameImageBitmap } from "../SomeTypes.js";
...
let target: (Window & typeof globalThis) | MessagePort = self;
